...
public class MainSearchAdapter extends RecyclerView.Adapter<MainSearchAdapter.MyViewHolder> implements Filterable {
    ...
    public MainSearchAdapter(Context context, ArrayList<String> list, OnItemClick onItemClick) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.main_search_item, parent, false);
